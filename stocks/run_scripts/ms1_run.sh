...
#python scripts/option_spread_watcher.py --rules  results/backtest_tight/grid_analysis_tight_successful.csv  --data-dir csv_exports/options/ --max-workers 4 --max-spend 40000 --verbose --db $QUEST_DB_STRING --log-level ERROR --interval 30 --max-spread-width 200
 ...
 python scripts/fetch_options.py --force-fetch --use-csv --symbols I:SPX I:RUT I:NDX --force-fetch --continuous --executor-type thread --snapshot-max-concurrent 50 --strike-range-percent 25 --refresh-threshold-seconds 1 --interval-multiplier .001 --data-dir ./csv_exports/ --days-ahead 2 --fetch-once-before-wait --use-market-hours


  python scripts/fetch_options.py --force-fetch --use-csv --symbols I:SPX I:DJX I:RUT I:NDX --force-fetch --continuous --executor-type thread --snapshot-max-concurrent 30  --strike-range-percent 100 --refresh-threshold-seconds 15 --interval-multiplier .5  --data-dir ./csv_exports/  --days-ahead 10 --fetch-once-before-wait --use-market-hours --start-from-days 2
