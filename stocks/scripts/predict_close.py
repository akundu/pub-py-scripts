...
async def predict_close(ticker='NDX', lookback=250, force_retrain=False, similar_days_count=10, db_config=None, days_ahead=0, target_date=None, use_time_decay=True, use_intraday_vol=True):
    ...
    # NOTE: Directional analysis (consecutive-day streaks, mean reversion) was tested
    # for 0DTE but showed no predictive value (42-50% directional accuracy, worse
    # midpoint error). It remains active for multi-day predictions (days_ahead > 0).
    # See scripts/backtest_directional_0dte.py for the experiment results.
