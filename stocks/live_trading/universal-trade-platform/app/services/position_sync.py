        ...
        for provider in providers:
            try:
                ...
                for bp in broker_positions:
                    ...
                    if existing is None:
                        # New position found — external purchase
                        # Preserve sign: negative = short position
                        ...
                        # Update mark on existing position
                        ...
                        if abs(old_qty - bp.quantity) > 0.001 or True:
                            # Always update mark
                            self._store.update_mark(
                                pos_id, current_mark, datetime.now(UTC)
                            )
